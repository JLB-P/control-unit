...
HD_PWD='C:/A_working/VHDL/basys3/unidad de control/unidad de control.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log unidad_de_control_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source unidad_de_control_main.tcl
